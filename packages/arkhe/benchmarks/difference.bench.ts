...
import { difference as differenceLodashEs_ } from 'lodash-es';
import { difference as differenceArkhe_ } from '../../pithos/src/arkhe/array/difference';

const differenceToolkit = differenceToolkit_;
const differenceCompatToolkit = differenceCompatToolkit_;
const differenceLodashEs = differenceLodashEs_;
const differenceArkhe = differenceArkhe_;
...
describe('difference', () => {
  ...
  bench('arkhe/difference', () => {
    differenceArkhe([1, 2, 3], [2]);
  });
});
...
describe('difference/largeArray', () => {
  ...
  bench('arkhe/difference', () => {
    differenceArkhe(largeArray, largeArray2);
  });
});
