...
import { string, object, optional, number } from '@pithos/core/kanon'
import { DUPLICATE_ISBN, BOOK_NOT_FOUND, STORAGE_FAILURE } from './book-errors'
...
export const errorBodySchema = object({
