    ...
    return (
      <div className={styles.fullscreenOverlay}>
        <div className={styles.fullscreenHeader}>
          <span>{translate({ id: 'playground.dashboard.title', message: 'Dashboard Demo' })}</span>
          <button
            className={styles.closeBtn}
            onClick={() => setIsFullscreen(false)}
            aria-label={translate({ id: 'playground.dashboard.closeFullscreen', message: 'Close fullscreen' })}
          >
            ✕
          </button>
        </div>
        <iframe
          ...
          title={translate({ id: 'playground.dashboard.title', message: 'Dashboard Demo' })}
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.mobileToggle}>
        ...
        >
          {translate({ id: 'playground.dashboard.code', message: 'Code' })}
        </button>
        <button
          className={`${styles.toggleBtn} ${mobileView === "preview" ? styles.active : ""}`}
          onClick={() => setMobileView("preview")}
        >
          {translate({ id: 'playground.dashboard.preview', message: 'Preview' })}
        </button>
      </div>
      ...
      <div className={styles.splitView}>
        ...
        <div className={`${styles.codePanel} ${mobileView === "code" ? styles.mobileVisible : styles.mobileHidden}`}>
          <div className={styles.panelHeader}>
            <span>{translate({ id: 'playground.dashboard.code', message: 'Code' })}</span>
          </div>
          <Tabs>
        ...
        <div className={`${styles.previewPanel} ${mobileView === "preview" ? styles.mobileVisible : styles.mobileHidden}`}>
          <div className={styles.panelHeader}>
            <span>{translate({ id: 'playground.dashboard.result', message: 'Result' })}</span>
            <button
              className={styles.fullscreenBtn}
              onClick={() => setIsFullscreen(true)}
              aria-label={translate({ id: 'playground.dashboard.fullscreen', message: 'Fullscreen' })}
              title={translate({ id: 'playground.dashboard.fullscreen', message: 'Fullscreen' })}
            >
              ⛶
            </button>
          </div>
