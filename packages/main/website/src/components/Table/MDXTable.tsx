 ...
 */
function removePrefixFromNode(node: ReactNode, prefix: string): ReactNode {
  // Handle simple string case (most common in Markdown tables)
  ...
  if (React.isValidElement(node)) {
    ...
    // Try to remove prefix from first text child
