---
sidebar_label: "Table d'équivalence"
sidebar_position: 5
title: "Table d'équivalence Pithos : Lodash, Zod, Neverthrow & plus"
description: "Table d'équivalence complète entre Pithos et les bibliothèques populaires d'utilitaires, de validation et de gestion d'erreurs"
...
1. **Utilitaires** : Fonctions utilitaires générales (Lodash, Es-toolkit, Remeda, Radashi, Ramda)
2. **Validation** : Bibliothèques de validation de schémas (Zod, Valibot, ArkType, Yup)
3. **Gestion d'erreurs** : Patterns fonctionnels de gestion d'erreurs (neverthrow, fp-ts, Effect, ts-results)
...
- ❌ = Non disponible dans Pithos
- `-` = Non disponible dans cette bibliothèque
- `≈` = Équivalent approximatif (API/comportement similaire mais non identique)
...
<RelatedLinks title="Comparaisons détaillées">

- [Arkhe vs Lodash — Taille de bundle](./arkhe/bundle-size.md) — Comparaison de taille par fonction
- [Kanon vs Zod — Interopérabilité](./kanon/interoperability.md) — Compatibilité fonctionnalité par fonctionnalité
- [Zygos vs Neverthrow — Interopérabilité](./zygos/interoperability.md) — Détails du remplacement direct
- [Vue d'ensemble des comparaisons](./overview.md) — Quand utiliser chaque module
